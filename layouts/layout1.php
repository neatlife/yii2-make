...
$themeBundle = Make::registerThemeAsset($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="morphsearch-content withScroll">
        <div class="dummy-column user-column">
          ...
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/avatars/avatar1_big.png" alt="Avatar 1"/>
            <h3>John Smith</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/avatars/avatar2_big.png" alt="Avatar 2"/>
            <h3>Bod Dylan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/avatars/avatar3_big.png" alt="Avatar 3"/>
            <h3>Jenny Finlan</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/avatars/avatar4_big.png" alt="Avatar 4"/>
            <h3>Harold Fox</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/avatars/avatar5_big.png" alt="Avatar 5"/>
            <h3>Martin Hendrix</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/avatars/avatar6_big.png" alt="Avatar 6"/>
            <h3>Paul Ferguson</h3>
          </a>
        </div>
        <div class="dummy-column">
          <h2>Articles</h2>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/1.jpg" alt="1"/>
            <h3>How to change webdesign?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/2.jpg" alt="2"/>
            <h3>News From the sky</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/3.jpg" alt="3"/>
            <h3>Where is the cat?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/4.jpg" alt="4"/>
            <h3>Just another funny story</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/5.jpg" alt="5"/>
            <h3>How many water we drink every day?</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/6.jpg" alt="6"/>
        ...
        <div class="dummy-column">
          <h2>Recent</h2>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/7.jpg" alt="7"/>
            <h3>Design Inspiration</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/8.jpg" alt="8"/>
            <h3>Animals drawing</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/9.jpg" alt="9"/>
            <h3>Cup of tea please</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/10.jpg" alt="10"/>
            <h3>New application arrive</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/11.jpg" alt="11"/>
            <h3>Notification prettify</h3>
          </a>
          <a class="dummy-media-object" href="#">
            <img src="<?= Make::$allAssetsBundle->baseUrl ?>/global/images/gallery/12.jpg" alt="12"/>
